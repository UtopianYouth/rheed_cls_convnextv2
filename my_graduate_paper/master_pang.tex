...
\renewcommand{\titleCN}{多任务反射式高能电子衍射图像分析方法研究}
\renewcommand{\titleEN}{Research on Multi-Task Analysis Methods for Reflection High-Energy Electron Diffraction Images}
...
%给目录和参考文献加上超链接（hyperref 已在 szu-master.cls 中加载，这里不要重复加载以避免 option clash）
